...
namespace XnaComponentSystem
{
    ...
    public class GameComponentCollection : ICollection<IGameComponent>
    {
        ...
        public void Update(TimeSpan elapsedTime, TimeSpan totalTime)
        {
            ...
            foreach (IUpdateable updateable in tempUpdateableComponents)
            {
                if (updateable.Enabled)
                    updateable.Update(elapsedTime, totalTime);
            }
        ...
        public void Draw(TimeSpan elapsedTime, TimeSpan totalTime)
        {
            ...
            {
                if (drawable.Visible)
                    drawable.Draw(elapsedTime, totalTime);
            }
        }
        ...
        /// Draws all visible components.
        /// </summary>
        public void Draw(GameTimerEventArgs e)
        {
            // Copy the components into our temporary list in case one of the Draw methods
            // modifies the component collection.
            tempDrawableComponents.Clear();
        ...
        public IGameComponent Index(int i)
        {
            return components[i];
        }
